  ...
  const socialLinks = [
    {
      icon: Linkedin,
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/dinisfigueiras/',
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`w-12 h-12 bg-card border border-border rounded-lg flex items-center justify-center transition-all duration-200 hover:border-primary/50 ${social.color}`}
                  >
